...
在线简历生成器。无须 fork 仓库，即可在线预览、编辑和下载 PDF 简历。✨ [在线编辑](https://loveayhz.github.io/resume)
...
|[Live Demo](https://loveayhz.github.io/resume?user=loveayhz)  |[Live Demo](https://loveayhz.github.io/resume?user=loveayhz&template=template2)|[Live Demo](https://loveayhz.github.io/resume?user=loveayhz&template=template3) |

## 如何使用（How to use）

**方式 1:**

在线编辑 -> 导出配置 -> 存储“简历信息”在个人 github special 仓库下（例如: [loveayhz/loveayhz](https://github.com/loveayhz/loveayhz/blob/master/resume.json)）

**方式 2:**

直接创建一个 `resume.json` 文件在自己的 special 仓库下 (内容参考: [loveayhz/loveayhz](https://github.com/loveayhz/loveayhz/blob/master/resume.json)).

**最后**

访问 https://loveayhz.github.io/resume?user={user}&branch={branch}
